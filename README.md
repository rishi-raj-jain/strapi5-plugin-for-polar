...
- [🪝 Webhooks (signature verification)](#-webhooks-signature-verification)
  - [🔗 1) Polar webhook endpoint URL](#-1-polar-webhook-endpoint-url)
  - [🔐 2) Create a webhook in Polar (get the signing secret)](#-2-create-a-webhook-in-polar-get-the-signing-secret)
  - [🧪 3) Local development (no public URL)](#-3-local-development-no-public-url)
